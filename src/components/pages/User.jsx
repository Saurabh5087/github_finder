...
function User() {
  ...
  // Destructing all the variables we need 
  // provided by the Github API for a user login
  const {
    ...
    <>
      <div className="w-full mx-auto lg:w-10/12">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8">
          ...
          {/* Profile Image, Username, Login_Name */}
          <div className="custom-card-image mb-6 md:mb-0">
            <div className="rounded-lg shadow-xl card image-full">
              <figure>
                <img src={avatar_url} alt="Profile_Photo" />
              </figure>
              <div className="card-body flex flex-cols justify-end">
                <div>
          ...
          {/* Right Side of profile Image */}
          {/* Username, bio, Github link, other Stats */}
